                ...
                <div id="dropshadowbox_shortcode_builder_container" class="wrap">
                    ...
                    <div style="padding:15px 15px 0 15px;"><?php _e("Effect:", "dropshadowboxes"); ?>
                        <select id="box_effect">
                            ...
                            <option
                                value="lifted-bottom-left"><?php _e("Lifted (Left)", "dropshadowboxes"); ?> </option>
                            <option
                                value="lifted-bottom-right"><?php _e("Lifted (Right)", "dropshadowboxes"); ?> </option>

                            <option value="curled"><?php _e("Curled", "dropshadowboxes"); ?> </option>
                            <option
                                value="perspective-left"><?php _e("Perspective (Left)", "dropshadowboxes"); ?> </option>
                            <option
                                value="perspective-right"><?php _e("Perspective (Right)", "dropshadowboxes"); ?> </option>
                            <option value="raised"><?php _e("Raised", "dropshadowboxes"); ?> </option>
                            <option
                                value="vertical-curve-left"><?php _e("Vertical Curve (Left)", "dropshadowboxes"); ?> </option>
                            <option
                                value="vertical-curve-both"><?php _e("Vertical Curve (Both)", "dropshadowboxes"); ?> </option>
                            <option
                                value="horizontal-curve-bottom"><?php _e("Horizontal Curve (Bottom)", "dropshadowboxes"); ?> </option>
                            <option
                                value="horizontal-curve-both"><?php _e("Horizontal Curve (Both)", "dropshadowboxes"); ?> </option>
                        </select>
                    ...
                    <div style="padding:15px 15px 0 15px;">
                        ...
                        <?php _e("Border (pixels):", "dropshadowboxes"); ?><input id="border_width" value="1"
                    ...
                    <div style="padding:15px 15px 0 15px;">
                        <input type="checkbox" id="rounded_corners" checked='checked'/> <label
                            for="rounded_corners"><?php _e("Rounded corners", "dropshadowboxes"); ?></label> &nbsp;&nbsp;&nbsp;
                        <input type="checkbox" id="inside_shadow" checked='checked'/> <label
                            for="inside_shadow"><?php _e("Inside shadow", "dropshadowboxes"); ?></label> &nbsp;&nbsp;&nbsp;
                        <input type="checkbox" id="outside_shadow" checked='checked'/> <label
                            for="outside_shadow"><?php _e("Outside shadow", "dropshadowboxes"); ?></label> &nbsp;&nbsp;&nbsp;

                    </div>

                    <div style="padding:15px 15px 0 15px;">
                        <textarea style="width:100%"
                                  id="box_content"><?php _e("Enter your content here.", "dropshadowboxes"); ?></textarea>
                        &nbsp;&nbsp;&nbsp;

                    </div>
                    <div style="padding:0px 15px 15px 15px;">
                        <input type="button" class="button-primary"
                               value="<?php _e("Refresh Preview", "dropshadowboxes"); ?>" onclick="RefreshPreview();"/>&nbsp;&nbsp;&nbsp;
                        <input type="button" class="button-primary"
                               value="<?php _e("Insert Box", "dropshadowboxes"); ?>"
                               onclick="SendDropShadowShortCodeToEditor();"/>&nbsp;&nbsp;&nbsp;
                        <a class="button" style="color:#bbb;" href="#"
                           onclick="tb_remove(); return false;"><?php _e("Cancel", "dropshadowboxes"); ?></a>
                    </div>
                    <fieldset style="border: 4px dashed #DDDDDD;width:90%;margin:0 15px 0 15px;">
                        <legend
                            style="color:#CCC;font-weight:bold;font-family: Helvetica, Arial;font-size: 1.8em"><?php _e("Preview", "dropshadowboxes"); ?></legend>
