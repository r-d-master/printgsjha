...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
	...
	add_image_size( 'homeslide', 960, 345, true ); // Homepage Slider
	add_image_size( 'blog-post', 160, 160, true ); // Post thumbnails
    add_image_size( 'homepage-portfolio-thumb', '203', '196', true ); // Homepage Portfolio thumbnails
    add_image_size( 'portfolio-thumb', '285', '196', true ); // Portfolio thumbnails
    add_image_size( 'portfolio-img', 960, 9999, true ); // Single Portfolio Image
	}
