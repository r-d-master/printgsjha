		...
		<div id="container">
			...
			<header role="banner">
					...
					<div id="topSearch">
						...
						<p style="font-family:ComfortaaBold;font-size:20px;line-height:1.3;margin-bottom:-17%;color:#fff;background:#F82C6D;padding:2%;">Free delivery <br/>over £100</p><br/>
						<p style="font-family:ComfortaaBold;font-size:20px;line-height:1.3;margin-bottom:-7%;">Call: 0207 993 8380<br/>info@printpedia.co.uk</p>
					</div>
					<!-- end #topSearch -->
